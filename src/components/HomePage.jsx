  ...
  <div className="page-home">
    <header className="home-header">
      <div className="home-header-inner">
        <span className="logo">🛡️ SafeSupport</span>
    ...
    <section className="hero-section">
      <div className="hero-content">
        <span className="hero-badge">Confidential & Secure</span>
        <h1>You Are Not Alone.<br />Help Is Here.</h1>
        <p>A safe, confidential platform providing legal guidance, counselling, and support for individuals facing domestic violence — regardless of gender.</p>
    ...
    <section className="services-section" id="services">
      ...
      <div className="services-grid">
        <div className="service-card">
          ...
          <a className="sc-link">Learn More →</a>
        </div>
        <div className="service-card">
    ...
    <footer className="home-footer">
      <div className="footer-inner">
        <div className="footer-logo">🛡️ SafeSupport</div>
