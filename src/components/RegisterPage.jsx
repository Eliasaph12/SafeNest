...
const RegisterPage = ({ onNavigate, onQuickExit, formData, onChange, onSubmit }) => (
      ...
      <div className="auth-form-wrap">
        ...
        <form onSubmit={onSubmit} className="auth-form">
          <div className="form-group">
            ...
            <input type="text" name="name" placeholder="Your full name" value={formData.name} onChange={onChange} required />
          </div>
          <div className="form-group">
